...
import { S as SignerWallet, C as ConnectedClient } from '../wallet-h2_C4cJt.mjs';
import { P as PaymentRequirements, U as UnsignedPaymentPayload, a as PaymentPayload, u as VerifyResponse, S as SettleResponse, b as ErrorReasons, E as ExactSvmPayload } from '../x402Specs-CfmzRyEi.mjs';
import { X as X402Config } from '../config-Dfuvno71.mjs';
import { TransactionSigner, Transaction, RpcDevnet, SolanaRpcApiDevnet, RpcMainnet, SolanaRpcApiMainnet, SendTransactionApi, CompilableTransactionMessage, Instruction, AccountLookupMeta, AccountMeta } from '@solana/kit';
import { b as getRpcSubscriptions } from '../rpc-ClI_Hiff.mjs';
 ...
 */
declare function verifyTransactionInstructions(transactionMessage: CompilableTransactionMessage, paymentRequirements: PaymentRequirements, signer: TransactionSigner, rpc: RpcDevnet<SolanaRpcApiDevnet> | RpcMainnet<SolanaRpcApiMainnet>): Promise<void>;
/**
...
}, signer: TransactionSigner, rpc: RpcDevnet<SolanaRpcApiDevnet> | RpcMainnet<SolanaRpcApiMainnet>): Promise<void>;
/**
